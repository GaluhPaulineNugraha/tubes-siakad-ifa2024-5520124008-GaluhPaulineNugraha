...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .brand-icon { font-size: 100px; color: rgba(255,255,255,0.2); margin-bottom: 30px; }
        .brand-title { font-size: 56px; font-weight: 800; color: white; margin-bottom: 20px; letter-spacing: 3px; }
        .brand-subtitle { font-size: 20px; color: rgba(255,255,255,0.85); margin-bottom: 15px; font-weight: 500; }
        .brand-desc { font-size: 16px; color: rgba(255,255,255,0.7); max-width: 360px; margin: 25px auto 0; line-height: 1.8; }
        .brand-line { width: 80px; height: 3px; background: rgba(255,255,255,0.3); margin: 30px auto 0; border-radius: 3px; }
        .brand-univ { font-size: 14px; color: rgba(255,255,255,0.5); margin-top: 35px; letter-spacing: 1px; }
        .form-section { display: flex; align-items: center; justify-content: center; padding: 40px; }
        .login-card {
        ...
        .login-header h3 { font-size: 26px; font-weight: 700; color: #1a2a3a; margin-bottom: 10px; }
        .login-header p { font-size: 14px; color: #6c757d; }
        .nav-beranda { text-align: center; margin-bottom: 20px; }
        .nav-beranda a { color: #6c757d; text-decoration: none; font-size: 14px; transition: all 0.2s; }
        .nav-beranda a:hover { color: #0A2540; }
        ...
        @media (max-width: 992px) { .brand-section { display: none; } .form-section { width: 100%; } }
        ...
        <div class="row g-0">
            <div class="col-lg-6 brand-section">
                <div class="brand-content">
                    ...
                    <p class="brand-desc">Platform digital untuk mengelola kegiatan akademik<br>Fakultas Teknik Informatika</p>
                    <div class="brand-line"></div>
                    <p class="brand-univ">Universitas Nugraha</p>
                </div>
            </div>
            ...
            <div class="col-lg-6 form-section">
                <div class="login-card">
                    ...
                    @if ($errors->any())
                        <div class="alert-danger"><i class="fas fa-exclamation-circle me-2"></i>{{ $errors->first() }}</div>
                    @endif

...
<body>
    ...
    <div class="info-section">
        <table class="info-table">
            ...
            <tr><td>Semester</td><td>: <strong>Genap 2024/2025</strong></td></tr>
            <tr><td>Dosen Wali</td><td>: <strong>{{ $mahasiswa->dosen->nama ?? '-' }}</strong></td></tr>
            <tr><td>Jumlah MK</td><td>: <strong>{{ $jadwal->count() }} Mata Kuliah</strong></td></tr>
        </table>
    </div>
    ...
    <table class="data-table">
        ...
        <tbody>
            ...
            @empty
            <tr><td colspan="8" style="text-align:center;padding:30px;color:#999;">Belum ada jadwal kuliah</td></tr>
            @endforelse
        </tbody>
    </table>

    <div class="footer">
        <div>Dokumen resmi Jadwal Kuliah - Universitas Nugraha</div>

    ...
    <div class="col-md-8 mx-auto">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0"><i class="fas fa-edit me-2"></i>Edit Dosen</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('dosen.update', $dosen->nidn) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nidn" class="form-control @error('nidn') is-invalid @enderror" 
                               value="{{ old('nidn', $dosen->nidn) }}" readonly style="background: #f0f0f0; cursor: not-allowed;">
                        <small class="text-muted">NIDN tidak dapat diubah karena terhubung dengan data lain</small>
                        @error('nidn')
